...
// TestTerminalTransitionsClearResetFlags verifies that reset_requested_options is cleared by every
...
func TestTerminalTransitionsClearResetFlags(t *testing.T) {
	makeActivity := func(ctx *chasm.MockMutableContext, status activitypb.ActivityExecutionStatus) *Activity {
		return &Activity{
			ActivityState: &activitypb.ActivityState{
				...
				Status:                 status,
				TaskQueue:              &taskqueuepb.TaskQueue{Name: "test-task-queue"},
				ResetRequestedOptions:  &activitypb.ResetRequestedOptions{ClearHeartbeats: true},
			},
	...
	t.Run("TransitionCompleted", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Nil(t, act.ResetRequestedOptions, "ResetRequestedOptions should be cleared byTransitionCompleted")
	})
	...
	t.Run("TransitionFailed", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Nil(t, act.ResetRequestedOptions, "ResetRequestedOptions should be cleared byTransitionFailed")
	})
	...
	t.Run("TransitionTerminated", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Nil(t, act.ResetRequestedOptions, "ResetRequestedOptions should be cleared byTransitionTerminated")
	})
	...
	t.Run("TransitionCanceled", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Nil(t, act.ResetRequestedOptions, "ResetRequestedOptions should be cleared byTransitionCanceled")
	})
	...
	t.Run("TransitionTimedOut", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Nil(t, act.ResetRequestedOptions, "ResetRequestedOptions should be cleared byTransitionTimedOut")
	})
}
