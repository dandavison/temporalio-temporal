...
type ActivityState struct {
	...
	// Unpause reset_attempts deferred until the running worker yields.
	UnpauseResetAttempts bool `protobuf:"varint,21,opt,name=unpause_reset_attempts,json=unpauseResetAttempts,proto3" json:"unpause_reset_attempts,omitempty"`
	// Unpause reset_heartbeat deferred until the running worker yields.
	UnpauseResetHeartbeat bool `protobuf:"varint,22,opt,name=unpause_reset_heartbeat,json=unpauseResetHeartbeat,proto3" json:"unpause_reset_heartbeat,omitempty"`
...
func (x *ActivityState) GetUnpauseResetAttempts() bool {
	if x != nil {
		return x.UnpauseResetAttempts
	}
	return false
}

func (x *ActivityState) GetUnpauseResetHeartbeat() bool {
	if x != nil {
		return x.UnpauseResetHeartbeat
	}
	return false
}
...
const file_temporal_server_chasm_lib_activity_proto_v1_activity_state_proto_rawDesc = "" +
	"\n" +
	"@temporal/server/chasm/lib/activity/proto/v1/activity_state.proto\x12+temporal.server.chasm.lib.activity.proto.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a&temporal/api/activity/v1/message.proto\x1a$temporal/api/common/v1/message.proto\x1a(temporal/api/deployment/v1/message.proto\x1a%temporal/api/failure/v1/message.proto\x1a'temporal/api/sdk/v1/user_metadata.proto\x1a'temporal/api/taskqueue/v1/message.proto\"\xb6\f\n" +
	"\rActivityState\x12I\n" +
	...
	"\x15reset_restore_options\x18\x14 \x01(\bR\x13resetRestoreOptions\x124\n" +
	"\x16unpause_reset_attempts\x18\x15 \x01(\bR\x14unpauseResetAttempts\x126\n" +
	"\x17unpause_reset_heartbeat\x18\x16 \x01(\bR\x15unpauseResetHeartbeat\"\xa7\x01\n" +
