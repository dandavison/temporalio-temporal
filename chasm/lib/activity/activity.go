...
// dispatchTimeForRetry computes the time a retried attempt is scheduled to be dispatched,
...
// TODO(dan): check whether reissueDispatchAndScheduleToStart should use this and why logic is slightly different.
