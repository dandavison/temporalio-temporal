...
func (c *StreamServiceLayeredClient) callPushStreamNoRetry(
	ctx context.Context,
	request *PushStreamRequest,
	opts ...grpc.CallOption,
) (*PushStreamResponse, error) {
	...
	metricsHandler := c.metricsHandler.WithTags(
		metrics.OperationTag("StreamService.PushStream"),
	...
	op := func(ctx context.Context, client StreamServiceClient) error {
		...
		defer cancel()
		response, err = client.PushStream(ctx, request, opts...)
		return err
	}
	err = c.redirector.Execute(ctx, shardID, op)
	return response, err
}
func (c *StreamServiceLayeredClient) PushStream(
	ctx context.Context,
	request *PushStreamRequest,
	opts ...grpc.CallOption,
) (*PushStreamResponse, error) {
	call := func(ctx context.Context) (*PushStreamResponse, error) {
		return c.callPushStreamNoRetry(ctx, request, opts...)
	}
