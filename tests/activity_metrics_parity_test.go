...
var activityMetricsScenarios = []activityMetricsScenario{
	...
	{name: "TerminalTimeout", trace: []model.Event{model.Poll, model.StartToCloseElapses}, cfg: activityConfig{MaxAttempts: 1, StartToClose: activityShortDuration}, anchor: metrics.ActivityTimeout.Name()},
